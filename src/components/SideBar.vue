<template>
  ...
  const navigation = [
    ...
    { name: 'Artists', href: '#', icon: CalendarIcon, current: false },
    { name: 'Genres', href: '#', icon: CalendarIcon, current: false },
    { name: 'Albums', href: '#', icon: CalendarIcon, current: false },
    { name: 'Tracks', href: '#', icon: MusicalNoteIcon, current: false },
